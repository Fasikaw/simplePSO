...
Parameter('kf_TNF_TNFR_bind', 2.40E-05) #r1
Parameter('kc_degrade_TNF', 0.001) #r2
Parameter('kr_TNF_TNFR_bind', 0.001) #r3
Parameter('kf_TNF_TNFR_bind_TRADD', 2.40E-05) #r4
Parameter('kr_TNF_TNFR_bind_TRADD', 0.001) #r5
Parameter('kf_TNF_TNFR_RIP1_TRADD_bind_A20', 2.40E-05) #r8
Parameter('kr_TNF_TNFR_RIP1_TRADD_bind_A20', 0.001) #r9
Parameter('kc_TNF_TNFR_RIP1_TRADD_A20_disassociate', 1.00E-01) #r10
Parameter('kf_RIP1_TRADD_bind_FADD', 2.40E+00) #r11
Parameter('kr_RIP1_TRADD_bind_FADD', 3.11E-07) #r12
Parameter('kf_RIP1_TRADD_FADD_bind_C8', 7.84E-05) #r13
Parameter('kf_RIP1_TRADD_FADD_bind_RIP3', 7.84E-05) #r14
Parameter('kr_RIP1_TRADD_FADD_bind_C8', 1.80E-02) #r15
Parameter('kr_RIP1_TRADD_FADD_bind_RIP3', 1.80E-02) #r16
Parameter('kf_RIP1_TRADD_FADD_C8_bind_FLIP', 7.84E-05) #r17
Parameter('kr_RIP1_TRADD_FADD_C8_bind_FLIP', 1.80E-02)  #r18
Parameter('kc_FLIP_activates_C8', 3.27E-02) #r19
Parameter('kf_TNF_TNFR_bind_RIP1', 2.40E-05) #r20
Parameter('kr_TNF_TNFR_bind_RIP1', 1.00E-03) #r21
Parameter('kf_TNF_TNFR_RIP1_bind_TRADD', 2.40E-05) #r22
Parameter('kr_TNF_TNFR_RIP1_bind_TRADD', 1.00E-03) #r23
Parameter('kc_RIP1_TRADD_FADD_RIP3_disassociate', 1.00E-01) #r24
Parameter('kc_RIP1_TRADD_FADD_C8_FLIP_disassociate', 1.00E-01) #r25
Parameter('kc_RIP3_phosphorylated', 1.00E-02) #r26
Parameter('kc_RIP1_phosphorylated', 1.00E-03) #r27
Parameter('kf_RIP1_RIP3_bind_MLKL', 2.40E-02) #r28
Parameter('kr_RIP1_RIP3_bind_MLKL', 1.00E-06) #r29
Parameter('kc_RIP1_RIP3_activate_MLKL', 1.00E+00) #r30
Parameter('kf_C8a_binds_BID', 2.40E-05) #r31
Parameter('kr_C8a_binds_BID', 1.00E-03) #r32
Parameter('kc_C8a_truncates_BID', 1.00E+00) #r33
...
#Initial Conditions
Parameter('TNF_0', 392)#2326     #698 is 30ng/ml of TNF
Parameter('TNFR_0', 200)#4800    #0.00246
Parameter('TRADD_0', 375)#9000
Parameter('RIP1_0', 1668)#random.randint(400, 400000)  #47000 0.04
Parameter('A20_0', 375)#random.randint(90, 90000)     #2256
Parameter('FADD_0', 335)#8030    #0.0033
Parameter('RIP3_0', 1668)#40000  #20000
Parameter('MLKL_0', 417)
Parameter('C8_0', 375)#random.randint(90, 90000)      #0.004 #0.09
Parameter('FLIP_0', 163)#3900    #0.004 #0.09
Parameter('BID_0', 417)
...
# plot titles
plotnames = {'C8.1.FADD.1.RIP1.1.TRADD.1.0':'Complex IIa',
            'FADD.1.RIP1.1.RIP3.1.TRADD.1.0':'Complex IIb',
            'A20.1.RIP1.1.TNF.1.TNFR.1.TRADD.1.0':'Complex I',
            'MLKL.1.1':'Phosphorylated MLKL',
            'Bid.1.1':'Truncated Bid',
            'C8.1.1':'Activated Caspase 8'}
